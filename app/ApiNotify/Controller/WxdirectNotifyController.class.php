...
class WxdirectNotifyController extends PaymentNotifyController
{
	private $payConfig = [];
	...
	public function checkSign($parameters)
	{
	    if(!$_POST)
	    {
	        exit("本页面是《微信免签约即时到账辅助》的通知网址，仅限用于填写到微信免签约即时到账辅助的通知网址设置项中与辅助软件通信，而不是直接访问<br /><br />官方网站：<a href='http://www.zfbjk.com' target='_blank'>http://www.zfbjk.com</a><br />客服QQ：40386277<br />E-mail：support@zfbjk.com");
	    }
